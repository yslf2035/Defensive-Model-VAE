...
# VAE模型生成轨迹的MPC跟踪测试
# 模型参数
model_path = 'training/models/vae_sce4_ld8_epoch2000.pth'  # 模型文件路径
seq_len = 10                  # 轨迹长度（sce3=12，其他=10）
dim = 3                       # 每个点的维度
latent_dim = 8                # 潜在空间维度
device = 'cpu'                # 计算设备
# CSV文件路径
csv_path = 'DefensiveData/UnpredictableMovementTown04/转向/exp_12_control_UnpredictableMovementTown04_1.csv'
# 起始点
